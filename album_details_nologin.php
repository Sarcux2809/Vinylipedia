<?php
session_start();
// Comentamos la verificación de sesión pero la mantenemos en el código
/* if (!isset($_SESSION['user']) || empty($_SESSION['user']['username'])) {
  header('Location: index.html');
  exit();
} */

// Usamos un valor por defecto si no hay usuario logeado
$nombreUsuario = isset($_SESSION['user']['username']) ? htmlspecialchars($_SESSION['user']['username']) : 'Invitado';
