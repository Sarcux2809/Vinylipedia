...
<body class="bg-gradient-to-r from-[#3a2a22] via-[#4a3f3a] to-[#2a3a2a] min-h-screen flex flex-col items-center p-4">
  <div
    class="w-full rounded-xl p-4 md:p-6 flex flex-col gap-4 md:gap-6 shadow-[0_0_40px_10px_rgba(0,255,0,0.2)] dynamic-bg"
  >
    <!-- Header -->
  ...
  <script>
    ...
    function filterResults() {
      ...
      // Mostrar/ocultar elementos según los filtros
      ...
      // Actualizar contadores de filtros aplicados
    ...
    function updateAppliedFilters(typeFilters, formatFilters) {
      ...
      typeFilters.forEach(filter => {
        ...
        span.innerHTML = `
          ...
          <button aria-label="Eliminar filtro" class="text-gray-300 hover:text-white">
